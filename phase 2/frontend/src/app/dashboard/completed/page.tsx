  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        ...
        // For "Completed" view, we'll show only completed tasks
      ...
      <div className="h-full flex flex-col">
        ...
        <header className="border-b border-zinc-200 dark:border-zinc-800 p-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Completed</h1>
          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            {tasks.length === 0 && !loading && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100 mb-1">No completed tasks</h3>
                <p className="text-zinc-500 dark:text-zinc-400">Complete some tasks to see them here.</p>
              </div>
            )}
          </div>
        </main>
